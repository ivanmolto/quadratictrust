  ...
  <div>
    ...
    >
      <div class="mb-2 hidden md:px-1 lg:px-4 sm:block">
        ...
        >
          <div class="h-20 md:h-24 flex flex-row items-center">
            ...
            <div
              class="ml-2 md:ml-8 lg:ml-36 flex flex-col w-32 items-end"
              :class="user.rank < 4 ? 'text-white' : 'text-trust-blue'"
            >
              <div
                class="
      ...
      <div class="mb-1 block sm:hidden px-4 py-2">
        ...
        >
          <div class="h-20 md:h-24 flex flex-row items-center">
            <div class="mt-1 mr-1.5 -ml-1 text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              class="flex-none ml-1 mr-8 inline-block p-0.5 rounded-full"
              :class="user.rank < 4 ? 'bg-trust-yellow' : 'bg-trust-blue'"
            >
              <img
                class="h-14 w-14 md:h-14 md:w-14 lg:h-16 lg:w-16 rounded-full"
                :src="user.image"
                alt=""
              />
            </div>
          ...
          <div class="mt-6 flex flex-row justify-center">
            <div
              class="flex flex-col w-28 items-center"
              :class="user.rank < 4 ? 'text-white' : 'text-trust-blue'"
            >
              <div class="font-raleway font-semibold text-2xl flex-none">
                {{ user.voteCredits }}
              </div>
              <div class="mb-6 font-karla flex-none text-xs">TRUST CREDIT</div>
            </div>
            <div class="ml-4 mr-4"></div>
            <div
              class="flex flex-col w-28 items-start"
              :class="user.rank < 4 ? 'text-white' : 'text-trust-blue'"
            >
              <div class="font-raleway font-semibold text-2xl flex-none">
                {{ user.votes }}
